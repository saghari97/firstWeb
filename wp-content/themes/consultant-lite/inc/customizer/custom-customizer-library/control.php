 ...
 */
class Consultant_Lite_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Consultant_Lite_Radio_Image_Control extends WP_Customize_Control {
 ...
 * @access public
 */
class Consultant_Lite_Customize_Section_Upsell extends WP_Customize_Section {
...
class Consultant_Lite_Customizer_Sections_Sortable_Control extends WP_Customize_Control {
  ...
  public function render_content() {
    ...
    <ul class="consultant-lite-sortable-list">
      ...
      ?>
        ...
        <li>
            <input class="consultant-lite-sortable-input sortable-hideme" name="<?php echo esc_attr( $value ); ?> " type="hidden"  value="<?php echo esc_attr( $value ); ?>" />
            <span class ="menu-item-handle sortable-span"> <?php echo esc_attr( $choices[$value] ); ?> </span>
          <i class="dashicons dashicons-menu consultant-lite-drag-handle"></i>
        </li>
        ...
        <li class="sortable-hideme">
          <input class="consultant-lite-sortable-value" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
        </li>
