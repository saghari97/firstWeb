...
class WEN_Corporate_Service_Widget extends WP_Widget {
	...
	function __construct() {
		$opts =array(
					...
					'description'   => __( 'Show your services with icon and read more link.', 'wen-corporate' ),
					'customize_selective_refresh' => true,
				);

		parent::__construct('wen-corporate-service', __('Corporate Service Widget', 'wen-corporate'), $opts);
	}
