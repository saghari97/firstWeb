...
function iqra_education_logo_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_setting('iqra_education_site_title_font_size',array(
		'default'	=> 33,
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('iqra_education_site_title_font_size',array(
		'label'	=> __('Logo Site Title Font Size','iqra-education'),
		'section'	=> 'title_tagline',
		'setting'	=> 'iqra_education_site_title_font_size',
		'type'	=> 'number',
		'input_attrs' => array(
			'step'             => 1,
			'min'              => 0,
...
function iqra_education_customize_controls_js() {
	wp_enqueue_script( 'iqra-education-customizer-controls', esc_url(get_template_directory_uri()) . '/inc/logo/js/customize-controls.js', array( 'jquery', 'customize-preview' ), '201709071000', true );
}
