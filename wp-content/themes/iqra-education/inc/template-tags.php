 ...
 * Posts pagination.
 */
if ( ! function_exists( 'iqra_education_pagination_option' ) ) {
	function iqra_education_pagination_type() {
		$iqra_education_pagination_type = get_theme_mod( 'iqra_education_pagination_option', 'Default' );
		if ( $iqra_education_pagination_type == 'Default' ) {
