...
class iqra_education_Icon_Changer extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <ul class="icon-list clearfix">
                    ...
                    <?php
                    $iqra_education_Icon_Changer_array = iqra_education_Icon_Changer_array();
                    foreach ($iqra_education_Icon_Changer_array as $iqra_education_Icon_Changer) {
                            $icon_class = $this->value() == $iqra_education_Icon_Changer ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($iqra_education_Icon_Changer).'"></i>
                            <span class="iqra-education-social-class">'.esc_attr($iqra_education_Icon_Changer).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function iqra_education_icon_customize_js() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'iqra-education-customize-icon', esc_url(get_template_directory_uri()).'/assets/js/customize-icon.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'iqra_education_icon_customize_js' );

if(!function_exists('iqra_education_Icon_Changer_array')){
    function iqra_education_Icon_Changer_array(){
        return array("", 
        "fab fa-500px",
