...
* @since BizFit 1.0.0
*/
if( ! class_exists( 'BizFit_Excerpt' ) ):

class BizFit_Excerpt{
...
/**
* Call to BizFit_Excerpt
*
* @since  1.0.0
* @uses   BizFit_Excerpt:::get_instance()->excerpt()
* @param  int $length
* @return void
*/
if( ! function_exists( 'bizfit_excerpt' ) ):

    function bizfit_excerpt( $length = 55, $echo = true, $more = '', $page_id = false ) {
        return BizFit_Excerpt::get_instance()->excerpt( $length, $echo, $more, $page_id );
    }
endif;