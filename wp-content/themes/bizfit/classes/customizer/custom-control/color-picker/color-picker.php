...
if ( class_exists( 'WP_Customize_Control' ) ) {
	...
	class BizFit_Customizer_Color_Control extends WP_Customize_Control {

		public $type = 'bizfit-color-picker';
		...
		public function enqueue() {
			wp_enqueue_script( 'wp-bizfit-color-picker' );
			wp_enqueue_style( 'wp-bizfit-color-picker' );
		}
...
bizfit_Customizer::add_custom_control( array(
    ...
    'class'    => 'BizFit_Customizer_Color_Control',
    'sanitize' => array( 'BizFit_Customizer', 'sanitize_rgba' ),
));