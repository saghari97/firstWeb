<?php
/**
 * Customizer Control: bizfit-buttonset.
 *
 * @since   1.0.0
 *
...
if ( class_exists( 'WP_Customize_Control' ) ){
	class BizFit_Customizer_Buttonset_Control extends WP_Customize_Control {
		...
		protected function content_template() {
			...
			<# } #>
			<div id="input_{{ data.id }}" class="bizfit-buttonset">
...
BizFit_Customizer::add_custom_control( array(
    ...
    'class'    => 'BizFit_Customizer_Buttonset_Control',
