 ...
 */
if( !class_exists( 'BizFit_Customizer_Slider_Integration' ) ){
	class BizFit_Customizer_Slider_Integration extends BizFit_Customizer{
		 ...
		 * @package BizFit WordPress Theme
		 */
		public static $type = 'bizfit-slider';

		public static $class = 'BizFit_Customizer_Slider_Control';
	...
	new BizFit_Customizer_Slider_Integration();
}