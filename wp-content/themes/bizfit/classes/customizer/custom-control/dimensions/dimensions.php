...
class BizFit_Customizer_Dimensions_Control extends WP_Customize_Control {
	...
	public function to_json() {
		...
		$this->json['title'] 	= esc_html__( 'Link values together', 'bizfit' );
	...
	protected function content_template() {
		...
		<ul class="desktop control-wrap active">
	        ...
	        <li class="dimension-wrap">
	            <div class="link-bizfit-dimensions">
	...
	protected function l10n( $id = false ) {
		$translation_strings = array(
			'desktop_top' 		=> esc_html__( 'Top', 'bizfit' 	),
			'desktop_right' 	=> esc_html__( 'Right', 'bizfit' 	),
			'desktop_bottom' 	=> esc_html__( 'Bottom', 'bizfit' ),
			'desktop_left' 		=> esc_html__( 'Left', 'bizfit' 	),
			'tablet_top' 		=> esc_html__( 'Top', 'bizfit' 	),
			'tablet_right' 		=> esc_html__( 'Right', 'bizfit' 	),
			'tablet_bottom' 	=> esc_html__( 'Bottom', 'bizfit' ),
			'tablet_left' 		=> esc_html__( 'Left', 'bizfit' 	),
			'mobile_top' 		=> esc_html__( 'Top', 'bizfit' 	),
			'mobile_right' 		=> esc_html__( 'Right', 'bizfit' 	),
			'mobile_bottom' 	=> esc_html__( 'Bottom', 'bizfit' ),
			'mobile_left' 		=> esc_html__( 'Left', 'bizfit' 	),
		);
		if ( false === $id ) {
