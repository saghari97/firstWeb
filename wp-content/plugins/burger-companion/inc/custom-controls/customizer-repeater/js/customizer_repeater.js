...
jQuery(document).ready(function () {
    ...
    burger_companion_theme_controls.on('click', '.customizer-repeater-new-field', function () {
        ...
        {
        if(jQuery('#exist_burger_companion_Spintech_Slider,#exist_burger_companion_ITpress_Slider,#exist_burger_companion_Burgertech_Slider').val()>=3)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_burger_companion_Spintech_Slider,#exist_burger_companion_ITpress_Slider,#exist_burger_companion_Burgertech_Slider').val()<3)
        {
         var new_service_add_val=parseInt(jQuery('#exist_burger_companion_Spintech_Slider,#exist_burger_companion_ITpress_Slider,#exist_burger_companion_Burgertech_Slider').val())+1;
         jQuery('#exist_burger_companion_Spintech_Slider,#exist_burger_companion_ITpress_Slider,#exist_burger_companion_Burgertech_Slider').val(new_service_add_val);  
        }
        }
		
		 if(split_add_more_button_split=="Add New Serv")
        {
        if(jQuery('#exist_burger_companion_Spintech_Service,#exist_burger_companion_ITpress_Service,#exist_burger_companion_Burgertech_Service').val()>=3)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_burger_companion_Spintech_Service,#exist_burger_companion_ITpress_Service,#exist_burger_companion_Burgertech_Service').val()<3)
        {
         var new_service_add_val=parseInt(jQuery('#exist_burger_companion_Spintech_Service,#exist_burger_companion_ITpress_Service,#exist_burger_companion_Burgertech_Service').val())+1;
         jQuery('#exist_burger_companion_Spintech_Service,#exist_burger_companion_ITpress_Service,#exist_burger_companion_Burgertech_Service').val(new_service_add_val);  
        }
        }
         if(split_add_more_button_split=="Add New Info")
        {
        if(jQuery('#exist_burger_companion_Spintech_Information,#exist_burger_companion_ITpress_Information').val()>=4)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_burger_companion_Spintech_Information,#exist_burger_companion_ITpress_Information').val()<4)
        {
         var new_service_add_val=parseInt(jQuery('#exist_burger_companion_Spintech_Information,#exist_burger_companion_ITpress_Information').val())+1;
         jQuery('#exist_burger_companion_Spintech_Information,#exist_burger_companion_ITpress_Information').val(new_service_add_val);  
        }
        }
		
		if(split_add_more_button_split=="Add New Soci")
        {
        if(jQuery('#exist_burger_companion_Spintech_Social,#exist_burger_companion_ITpress_Social,#exist_burger_companion_Burgertech_Social').val()>=3)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_burger_companion_Spintech_Social,#exist_burger_companion_ITpress_Social,#exist_burger_companion_Burgertech_Social').val()<3)
        {
         var new_service_add_val=parseInt(jQuery('#exist_burger_companion_Spintech_Social,#exist_burger_companion_ITpress_Social,#exist_burger_companion_Burgertech_Social').val())+1;
         jQuery('#exist_burger_companion_Spintech_Social,#exist_burger_companion_ITpress_Social,#exist_burger_companion_Burgertech_Social').val(new_service_add_val);  
        }
        }
		
		if(split_add_more_button_split=="Add New Desi")
        {
        if(jQuery('#exist_burger_companion_Spintech_Design,#exist_burger_companion_ITpress_Design,#exist_burger_companion_Burgertech_Design').val()>=8)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_burger_companion_Spintech_Design,#exist_burger_companion_ITpress_Design,#exist_burger_companion_Burgertech_Design').val()<8)
        {
         var new_service_add_val=parseInt(jQuery('#exist_burger_companion_Spintech_Design,#exist_burger_companion_ITpress_Design,#exist_burger_companion_Burgertech_Design').val())+1;
         jQuery('#exist_burger_companion_Spintech_Design,#exist_burger_companion_ITpress_Design,#exist_burger_companion_Burgertech_Design').val(new_service_add_val);  
        }
        }
		...
		if(split_add_more_button_split=="Add New Slid")
        {
			if(jQuery('#exist_burger_companion_CoziPress_Slider,#exist_burger_companion_Sipri_Slider').val()>=3)
				{
            ...
            if(jQuery('#exist_burger_companion_CoziPress_Slider,#exist_burger_companion_Sipri_Slider').val()<3)
				{
					var new_service_add_val=parseInt(jQuery('#exist_burger_companion_CoziPress_Slider,#exist_burger_companion_Sipri_Slider').val())+1;
					jQuery('#exist_burger_companion_CoziPress_Slider,#exist_burger_companion_Sipri_Slider').val(new_service_add_val);  
				}
        }
		
		 if(split_add_more_button_split=="Add New Info")
        {
			if(jQuery('#exist_burger_companion_CoziPress_Information').val()>=4)
				{
			 ...
			 if(jQuery('#exist_burger_companion_CoziPress_Information').val()<4)
				{
					var new_service_add_val=parseInt(jQuery('#exist_burger_companion_CoziPress_Information').val())+1;
					jQuery('#exist_burger_companion_CoziPress_Information').val(new_service_add_val);  
				}
        }
		
		 if(split_add_more_button_split=="Add New Serv")
        {
			if(jQuery('#exist_burger_companion_CoziPress_Service,#exist_burger_companion_Sipri_Service').val()>=3)
				{
			 ...
			 if(jQuery('#exist_burger_companion_CoziPress_Service,#exist_burger_companion_Sipri_Service').val()<3)
				{
					var new_service_add_val=parseInt(jQuery('#exist_burger_companion_CoziPress_Service,#exist_burger_companion_Sipri_Service').val())+1;
					jQuery('#exist_burger_companion_CoziPress_Service,#exist_burger_companion_Sipri_Service').val(new_service_add_val);  
				}
        }
		
		if(split_add_more_button_split=="Add New Test")
        {
			if(jQuery('#exist_burger_companion_CoziPress_Testimonial,#exist_burger_companion_Sipri_Testimonial').val()>=3)
				{
			 ...
			 if(jQuery('#exist_burger_companion_CoziPress_Testimonial,#exist_burger_companion_Sipri_Testimonial').val()<3)
				{
					var new_service_add_val=parseInt(jQuery('#exist_burger_companion_CoziPress_Testimonial,#exist_burger_companion_Sipri_Testimonial').val())+1;
					jQuery('#exist_burger_companion_CoziPress_Testimonial,#exist_burger_companion_Sipri_Testimonial').val(new_service_add_val);  
				}
        }
		
		if(split_add_more_button_split=="Add New Soci")
        {
			if(jQuery('#exist_burger_companion_CoziPress_Social,#exist_burger_companion_Sipri_Social').val()>=3)
				{
			 ...
			 if(jQuery('#exist_burger_companion_CoziPress_Social,#exist_burger_companion_Sipri_Social').val()<3)
				{
					var new_service_add_val=parseInt(jQuery('#exist_burger_companion_CoziPress_Social,#exist_burger_companion_Sipri_Social').val())+1;
					jQuery('#exist_burger_companion_CoziPress_Social,#exist_burger_companion_Sipri_Social').val(new_service_add_val);  
				}
        }
    ...
    burger_companion_theme_controls.on('click', '.social-repeater-general-control-remove-field', function () {
        ...
        if (typeof    jQuery(this).parent() !== 'undefined') {
            jQuery(this).parent().hide(500, function(){
                ...
                {
                jQuery('#exist_burger_companion_Spintech_Slider,#exist_burger_companion_ITpress_Slider,#exist_burger_companion_Burgertech_Slider').val(parseInt(jQuery('#exist_burger_companion_Spintech_Slider,#exist_burger_companion_ITpress_Slider,#exist_burger_companion_Burgertech_Slider').val())-1);  
                }
				if(split_delete_button_split=="Delete Servi")
                {
                jQuery('#exist_burger_companion_Spintech_Service,#exist_burger_companion_ITpress_Service,#exist_burger_companion_Burgertech_Service').val(parseInt(jQuery('#exist_burger_companion_Spintech_Service,#exist_burger_companion_ITpress_Service,#exist_burger_companion_Burgertech_Service').val())-1);  
                }
				if(split_delete_button_split=="Delete Infor")
                {
                jQuery('#exist_burger_companion_Spintech_Information,#exist_burger_companion_ITpress_Information').val(parseInt(jQuery('#exist_burger_companion_Spintech_Information,#exist_burger_companion_ITpress_Information').val())-1); 
                }
				if(split_delete_button_split=="Delete Socia")
                {
                jQuery('#exist_burger_companion_Spintech_Social,#exist_burger_companion_ITpress_Social,#exist_burger_companion_Burgertech_Social').val(parseInt(jQuery('#exist_burger_companion_Spintech_Social,#exist_burger_companion_ITpress_Social,#exist_burger_companion_Burgertech_Social').val())-1); 
                }
				if(split_delete_button_split=="Delete Desig")
                {
                jQuery('#exist_burger_companion_Spintech_Design,#exist_burger_companion_ITpress_Design,#exist_burger_companion_Burgertech_Design').val(parseInt(jQuery('#exist_burger_companion_Spintech_Design,#exist_burger_companion_ITpress_Design,#exist_burger_companion_Burgertech_Design').val())-1); 
                }
				...
				if(split_delete_button_split=="Delete Slide")
                {
                jQuery('#exist_burger_companion_CoziPress_Slider,#exist_burger_companion_Sipri_Slider').val(parseInt(jQuery('#exist_burger_companion_CoziPress_Slider,#exist_burger_companion_Sipri_Slider').val())-1);  
                }
				
				if(split_delete_button_split=="Delete Infor")
                {
                jQuery('#exist_burger_companion_CoziPress_Information').val(parseInt(jQuery('#exist_burger_companion_CoziPress_Information').val())-1); 
                }
				
				
				if(split_delete_button_split=="Delete Servi")
                {
                jQuery('#exist_burger_companion_CoziPress_Service,#exist_burger_companion_Sipri_Service').val(parseInt(jQuery('#exist_burger_companion_CoziPress_Service,#exist_burger_companion_Sipri_Service').val())-1); 
                }
				
				
				if(split_delete_button_split=="Delete Testi")
                {
                jQuery('#exist_burger_companion_CoziPress_Testimonial,#exist_burger_companion_Sipri_Testimonial').val(parseInt(jQuery('#exist_burger_companion_CoziPress_Testimonial,#exist_burger_companion_Sipri_Testimonial').val())-1); 
                }
				
				
				if(split_delete_button_split=="Delete Socia")
                {
                jQuery('#exist_burger_companion_CoziPress_Social,#exist_burger_companion_Sipri_Social').val(parseInt(jQuery('#exist_burger_companion_CoziPress_Social,#exist_burger_companion_Sipri_Social').val())-1); 
                }
            });
        }
        return false;
